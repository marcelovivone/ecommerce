...
<form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="marcelovivone@gmail.com">  
  ...
  <!-- Botão eliminado para o formulário ser enviado diretamente via código javascript abaixo
       Assim, foi eliminada mais uma etapa para o usuário, que teria que clicar no botão do
       pagseguro para executar o formulário
