...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>TILA</strong><br>
                Rua Voluntário da Pátria, 37 - Botafogo<br>
                Rio de Janeiro - RJ<br>
                Telefone: (21) 3804-8600<br>
                E-mail: marcelovivone@gmail.com
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>R$<?php echo formatBR($order["vltotal"]); ?></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <tbody><tr>
                    ...
                    <td>R$<?php echo formatBR($cart["vlsubtotal"]); ?></td>
                </tr>
                <tr>
                    <th>Frete:</th>
                    <td>R$<?php echo formatBR($cart["vlfreight"]); ?></td>
                </tr>
                <tr>
                    <th>Total:</th>
                    <td>R$<?php echo formatBR($cart["vltotal"]); ?></td>
                </tr>
                </tbody></table>
            </div>
            </div>
